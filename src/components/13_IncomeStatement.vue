...
import { useIncomeStatement } from "@/composables/13_useIncomeStatement";
...
const tableData = computed(() => {
  ...
  return [
    ...
    {
      indicator: "Себестоимость продаж, руб.",
      values: costOfSales,
    },
    {
      indicator: "Управленческие расходы, руб.",
      values: managementExpenses,
    },
    {
      indicator: "Коммерческие расходы, руб.",
      values: sellingExpenses,
    },
    {
      indicator: "Прибыль, руб.",
      values: total,
    },
  ];
});
